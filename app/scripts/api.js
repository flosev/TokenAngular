...
"use strict";
angularRestfulAuth
    .service('api', ['client','utils', 'configure', function(client, utils, configure) {

/*
var client = require('./scripts/client');
 ...
 */
this.generateToken = function generateToken(config, cb) {
 ...
 * @param  {Function} cb                    Callback function
 */
this.executeHttp = function executeHttp(http_method, path, data, http_options, cb) {
