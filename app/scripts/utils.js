...
this.getDefaultEndpoint = function getDefaultEndpoint(mode) {
    return (typeof mode === "string" && mode === "live") ? "paypal.com" : "sandbox.paypal.com";
};

this.getDefaultApiEndpoint = function getDefaultApiEndpoint(mode) {
 ...
 * @return {Object}     
 */
this.merge = function merge(obj1, obj2) {
 ...
 */
this.checkExpiredToken = function checkExpiredToken(token_hash) {
