'use strict';
//angular.module('angularRestfulAuth1',[])
angularRestfulAuth
    .factory('client', ['$http', '$https', 'configure', function($http, $https, configure) {
 ...
 */
    ...
    return {
        invoke: function invoke(http_method, path, data, http_options_param, cb) {
